    ...
    <body>
                <div class="container mt-5">
                    <form action="update.php" method="POST">
                                ...
                                <input type="hidden" name="cod_estudiante" value="<?php echo $row['idUsuario']  ?>">
                                
                                <input type="text" class="form-control mb-3" name="correo" placeholder="correousuario" value="<?php echo $row['correo']  ?>">
